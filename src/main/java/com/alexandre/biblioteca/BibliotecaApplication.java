...
public class BibliotecaApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Exemplar l1 = new Exemplar(null, "Reinações de Narizinho", "Sinopse",
		...
		Exemplar l2 = new Exemplar(null, "O saci", "Sinopse", "978-8525062130", "2016",
		...
		Exemplar l3 = new Exemplar(null, "Dom Casmurro", "Sinopse", "857-2322647", "2010",
		...
		Emprestimo emp1 = new Emprestimo(null, sdf.parse("04/02/2020 10:12"), sdf.parse("14/02/2020 08:00"), leitor1, l1);
		
//		l1.getEmprestimos().addAll(Arrays.asList(emp1));

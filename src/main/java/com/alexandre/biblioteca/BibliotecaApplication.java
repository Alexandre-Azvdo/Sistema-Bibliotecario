...
//				);
		...
		Leitor leitor1 = new Leitor(null, "Alexandre Azevedo", sdf.parse("21/05/1985"), "054.630.324-24", StatusLeitor.ATIVO, contato1);
		Leitor leitor2 = new Leitor(null, "Gustavo Rafael", sdf.parse("26/03/2019"), "021.310.665-98", StatusLeitor.ATIVO, contato2);
